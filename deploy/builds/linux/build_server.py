...
def build_release(version: str, *, package_format: str) -> None:
    ensure_platform("linux")
    build_component("linux", COMPONENT, version)
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build the Zertan Linux server package.")
...
def command_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Linux server build and packaging helper.")
    ...
    install_parser = subparsers.add_parser("install", help="Install the generated server package.")
    install_parser.add_argument("--version", required=True, help="Package version to install.")
    install_parser.add_argument(
        "--install-only",
        action="store_true",
        help="Install the package but do not attempt to launch the server.",
    )
...
def main(argv: list[str] | None = None) -> None:
    ...
    build_release(args.version, package_format=args.format)
