...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build the Zertan Lite Linux package.")
...
def command_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Linux Lite build and packaging helper.")
    ...
    install_parser = subparsers.add_parser("install", help="Install the generated Lite package.")
    install_parser.add_argument("--version", required=True, help="Package version to install.")
    install_parser.add_argument(
        "--install-only",
        action="store_true",
        help="Install the package but do not attempt to launch Lite.",
    )
