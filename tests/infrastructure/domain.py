...
def api_manager():
    return run_test_module("tests.infrastructure.test_api_manager")


def database_runtime():
    return run_test_module("tests.infrastructure.test_database_runtime")


def db_manager():
    return run_test_module("tests.infrastructure.test_db_manager")


def infrastructure_lifecycle():
    return run_test_module("tests.infrastructure.test_infrastructure_lifecycle")
