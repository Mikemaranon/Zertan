...
def admin_api():
    return run_test_module("tests.core.users.test_admin_api")


def auth_user_api():
    return run_test_module("tests.core.users.test_auth_user_api")


def base_api():
    return run_test_module("tests.core.users.test_base_api")


def user_manager():
    return run_test_module("tests.core.users.test_user_manager")
