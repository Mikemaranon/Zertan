...
def app_routes():
    return run_test_module("tests.core.system.test_app_routes")


def connection_info_service():
    return run_test_module("tests.core.system.test_connection_info_service")


def runtime_config():
    return run_test_module("tests.core.system.test_runtime_config")


def storage_paths():
    return run_test_module("tests.core.system.test_storage_paths")
